<template>
  <div class="wrap">
    <div class="container">
      <div class="wrappper">
        <div class="left">
          <button
            class="burger"
            @click="mobileHandle = !mobileHandle"
            :class="{ burgerX: mobileHandle }"
          >
            <div class="stick"></div>
          </button>
        </div>
        <div class="mid">
          <NuxtLink :to="`/${$route.params.lang}`" class="brando">
            <img src="@/assets/img/logo/brand.svg" alt="" />
          </NuxtLink>
        </div>
        <div class="right">
          <a href="tel:+998901400000" class="tel">
      ...
      <div class="container container-big">
        <div class="rel">
          ...
          <div id="dropdown" class="dropdown" :class="{ show: dropHandle }">
            ...
            <div class="drop__body">
              <div class="drop__left" v-if="categoriesChild.length == 0">
                <button
              ...
              <div class="drop__right" v-else>
                <button class="back__btn" @click="categoriesChild = []">
        ...
        <div class="bottom__links">
          <ul>
            <li>
              <Nuxt-link
                :to="`/${$route.params.lang}/products/30?category=30`"
                class="bottom__link"
              >
                <svg
                  width="28"
    ...
    <div class="menu" :class="{ show: mobileHandle }">
      <ul>
        <li>
          <NuxtLink class="link" :to="`/${$route.params.lang}/about`">{{
            $store.state.translations['main.about']
          }}</NuxtLink>
        </li>
        <!-- <li>
          <NuxtLink class="link" to="/products/1">{{
            $store.state.translations['main.products']
          }}</NuxtLink>
        </li> -->
        <li>
          <NuxtLink class="link" :to="`/${$route.params.lang}/cart`">{{
        ...
        <li>
          <NuxtLink class="link" :to="`/${$route.params.lang}/shifts`">{{
            $store.state.translations['main.shifts']
          }}</NuxtLink>
        </li>
        <li>
          <NuxtLink class="link" :to="`/${$route.params.lang}/baths`">{{
            $store.state.translations['main.baths']
          }}</NuxtLink>
        </li>
        <li>
          <NuxtLink class="link" :to="`/${$route.params.lang}/toilet`">{{
            $store.state.translations['main.toilet']
          }}</NuxtLink>
        </li>
        <!-- <li>
