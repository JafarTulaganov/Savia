<template>
  <div class="wrap">
    <div class="container">
      <h4 class="title">{{ $store.state.translations['product.similar'] }}</h4>

      <div class="swiper-wrap">
        <div class="swiper-button-prev batton prev slider-prev">
            ...
            <div v-for="item in products" :key="item.id" class="swiper-slide">
              <div class="cardo">
                ...
                <div class="btns">
                  ...
                  <button
                    @click="
                      $store.commit('addToCart', { id: item.id, count: 1 })
                    "
                    class="cart"
                  >
                    <svg
        ...
        <div class="swiper-button-next batton next slider-next">
